								...
								<div class="col-lg-3 col-md-6">
									<div class="panel panel-red">
										<div class="panel-heading">
											<div class="row" id="person1" name1="${plist.stName }"
							...
							<c:when test="${i.index==2 }">
								<div class="col-lg-3 col-md-6">
									<div class="panel panel-yellow">
										<div class="panel-heading">
											<div class="row" id="person2" name1="${plist.stName }"
												num1="${p_count[plist.stNum] }">
												<div class="col-xs-5">
													<span>${plist.stName }</span>
													<p>(${plist.stNum })</p>
							...
							<c:when test="${i.index==1 }">
								<div class="col-lg-3 col-md-6">
									<div class="panel panel-green">
										<div class="panel-heading">
											<div class="row" id="person3" name1="${plist.stName }"
												num1="${p_count[plist.stNum] }">
												<div class="col-xs-5">
													<span>${plist.stName }</span>
													<p>(${plist.stNum })</p>
							...
							<c:when test="${i.index==0 }">
								<div class="col-lg-3 col-md-6">
									<div class="panel panel-primary">
										<div class="panel-heading">
											<div class="row" id="person4" name1="${plist.stName }"
												num1="${p_count[plist.stNum] }">
												<div class="col-xs-5">
													<span>${plist.stName }</span>
													<p>(${plist.stNum })</p>
...
var teamData = {"idx":fk,"teamURL":url,"leaderNum":leaderNum,"gitName":leaderGitName};
