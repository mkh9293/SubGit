        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="${pageContext.request.contextPath}/svn/teampage/team"><i class="fa fa-fw fa-dashboard"></i> Team</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/svn/teampage/browse"><i class="fa fa-fw fa-desktop"></i>FileBrowse</a>
                    </li>
                    <li>
                        ...
                        <c:forEach var="plist" items="${p_list }" varStatus="i">
                            <li>
                                <a href="${pageContext.request.contextPath}/svn/teampage/member?st=${plist.stNum }">${plist.stName }</a>
                            </li>
                         </c:forEach>
                        </ul>
                    </li>
